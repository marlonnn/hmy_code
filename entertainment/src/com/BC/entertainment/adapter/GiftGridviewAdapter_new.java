...
public class GiftGridviewAdapter_new extends BaseAdapter{
	
	private Context context;

	private List<BaseGift_new> baseGifts;

//	private List<Drawable> drawableCache;
	
	public GiftGridviewAdapter_new(Context context, List<BaseGift_new> baseGifts) {
...
//	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		BaseGift_new viewHolder = baseGifts.get(position);
