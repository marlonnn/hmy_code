...
import com.BC.entertainment.chatroom.module.Container_new;
import com.netease.nimlib.sdk.msg.constant.SessionTypeEnum;
import com.netease.nimlib.sdk.msg.model.IMMessage;

@SuppressWarnings("serial")
public abstract class BaseGift_new implements Serializable{
	...
	private transient Container_new container;
	...
	protected BaseGift_new(int customAttachmentType, int category, String name, int iconResId, int value, int exPoints)
	{
		this.customAttachmentType = customAttachmentType;
		this.category = category;
		this.name = name;
    ...
    public String getAccount() {
        return ChatCache.getInstance().getChatRoom().getChatroomid();
    }

    public SessionTypeEnum getSessionType() {
        return container.getSessionType();
    }
    
    public Container_new getContainer() {
        return container;
    }
    
    public void setContainer(Container_new container) {
    ...
    protected void sendMessage(IMMessage message) {
    	if(container != null && container.getActivityCallback() != null)
    	{
            container.getActivityCallback().sendMessage(message);
    	}
    }
    ...
    protected void showAnimation(Gift gift)
    {
    	if(container != null && container.getActivityCallback() != null)
    	{
            container.getActivityCallback().showAnimation(gift);
    	}
    }
}
