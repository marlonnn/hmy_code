...
public class CardBuyFragment extends BaseFragment implements OnClickListener{

	private List<CardOrder> buyCards = new ArrayList<>();
	private int pageIndex = 1;
	private Gson gson;
	private View rootView;
	private CommonAdapter<CardOrder> adapter;
	private PullToRefreshGridView pGridViewBuy;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		rootView = inflater.inflate(R.layout.fragment_card_buy, null);
		return rootView;
	}
	...
	{
		pGridViewBuy = (PullToRefreshGridView) rootView.findViewById(R.id.pGridViewBuy);
		pGridViewBuy.getRefreshableView().setNumColumns(1);
		pGridViewBuy.getRefreshableView().setVerticalSpacing(10);
		pGridViewBuy.setMode(PullToRefreshBase.Mode.BOTH);
		pGridViewBuy.setOnRefreshListener(refreshListener);
		pGridViewBuy.setOnItemClickListener(new OnItemClickListener() {
		...
		pGridViewBuy.setAdapter(adapter);
	}
	...
	OnRefreshListener2<GridView> refreshListener = new OnRefreshListener2<GridView>() {
		...
		public void onPullDownToRefresh(PullToRefreshBase<GridView> refreshView) {
			...
			pGridViewBuy.getLoadingLayoutProxy().setRefreshingLabel(
					"正在刷新");
			pGridViewBuy.getLoadingLayoutProxy().setPullLabel("下拉刷新");
			pGridViewBuy.getLoadingLayoutProxy().setReleaseLabel(
					"释放开始刷新");
		...
		public void onPullUpToRefresh(PullToRefreshBase<GridView> refreshView) {
			...
			pGridViewBuy.getLoadingLayoutProxy().setRefreshingLabel(
					"正在加载");
			pGridViewBuy.getLoadingLayoutProxy().setPullLabel("上拉翻页");
			pGridViewBuy.getLoadingLayoutProxy().setReleaseLabel(
					"释放开始加载");
			refreshView.getLoadingLayoutProxy().setLastUpdatedLabel(
					"最后加载时间:" + time);
	...
	public void onInfoReceived(int errcode, HashMap<String, Object> items) {
		...
		pGridViewBuy.onRefreshComplete();
	}
