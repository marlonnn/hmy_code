...
public class TopPushFragment extends DialogFragment {
	...
	public TopPushFragment(Activity activity, ChatRoom chatRoom)
	{
		pushFragment = new PushFragment(activity, chatRoom);
